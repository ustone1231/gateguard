...
- **[무임승차 탐지 전략](docs/detection-strategy.md)** — "이 프로젝트가 정확히 뭘 푸는가" 의 답. CCTV (행동) + AFC (결제) 매칭 아키텍처
- [시스템 아키텍처](docs/architecture.md) — 트랙 분리 / 기술 스택 / 데이터 흐름
- [브랜치 전략](docs/branching.md) — 협업 워크플로 (Git Flow)
